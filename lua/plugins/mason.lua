local plugins = {
  ...
  -- Mason LSPConfig: Integration between Mason and lspconfig
  {
    ...
    config = function()
      ...
      -- Go (gopls) configuration with auto import
      ...
      -- Auto-format and auto-import on save for Go files
      vim.api.nvim_create_autocmd("BufWritePre", {
        group = vim.api.nvim_create_augroup("GoAutoImportAndFormat", { clear = true }),
        pattern = "*.go",
        callback = function()
